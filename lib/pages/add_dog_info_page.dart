...
import 'add_dog_picture_page.dart';
...
class AddDogInfoPage extends StatefulWidget {

  final FirebaseUser user;

  AddDogInfoPage({@required this.user});

  @override
  _AddDogInfoPageState createState() => _AddDogInfoPageState();
}

class _AddDogInfoPageState extends State<AddDogInfoPage> {
        ...
        new TextActionButton(
          ...
          onPressed: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (BuildContext context) => AddDogPicturePage(
                  name: nameTextController.text,
                  dateOfBirth: dateOfBirth,
                  user: widget.user,
                ),
